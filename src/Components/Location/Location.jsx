...
export default function Location() {
    ...
    return (    
        ...
        <div className="about-location flex w-[80vw]  bg-black text-white mx-auto justify-between mt-20 gap-5 mb-20">
            <div className="about-address border-2 p-10 border-black w-1/2">
            <h1 className="address text-xl font-bold mb-10 text-start underline"> Address:  </h1>
