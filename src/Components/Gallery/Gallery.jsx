...
const Gallery = () => {
  return (
    <>
        ...
        <h1 className='Gallery-interior-h1 w-[80vw] mt-20 mx-auto text-center text-3xl font-bold text-black bg-white border-2 border-black ring-2 ring-slate-300 p-3 shadow-black'>Gym Interior</h1>
    <div className='Gallery-interior w-[80vw] mx-auto bg-black mb-10 h-[50vh] overflow-auto'>
        <div className='interior-grid grid grid-cols-4 justify-items-center auto-cols-auto gap-y-20 p-10'>
        <div>
            <img className='img-interior h-[50vh] w-[250px]' src="assets/Gym-1.jpg" alt="" />
        </div>
        <div>
    ...
    <h1 className='Gallery-gym-h1 w-[80vw] mx-auto text-center text-3xl font-bold text-black bg-white border-2 border-black ring-2 ring-slate-300 p-3 shadow-black'>Gym Related Gallery</h1>
    <div className='Gallery-gym w-[80vw] mx-auto bg-black overflow-auto h-[50vh] mb-5'>
      <div className='gym-grid grid grid-cols-4 justify-items-center auto-cols-auto gap-y-20 p-10'>
        <div className=''>
