...
const Gallery = () => {
  return (
    ...
    <div className='w-[80vw] mx-auto bg-black mt-20 mb-10'>
        ...
        <div>
            <img className='h-[50vh] w-[250px]' src="src/assets/Gym-1.jpg" alt="" />
        </div>
        <div>
            <img className='h-[50vh] w-[250px]' src="src/assets/Gym-2.jpg" alt="" />
        </div>
        <div>
            <img className='h-[50vh] w-[250px]' src="src/assets/Gym-3.jpg" alt="" />
        </div>
        <div>
            <img className='h-[50vh] w-[250px]' src="src/assets/Gym-4.jpg" alt="" />
        </div>
        <div>
            <img className='h-[50vh] w-[250px]' src="src/assets/Gym-5.jpg" alt="" />
        </div>
        <div>
            <img className='h-[50vh] w-[250px]' src="src/assets/Gym-6.jpg" alt="" />
        </div>
        <div>
            <img className='h-[50vh] w-[250px]' src="src/assets/Gym-7.jpg" alt="" />
        </div>
        <div>
            <img className='h-[50vh] w-[250px]' src="src/assets/Gym-8.jpg" alt="" />
        </div>
        <div>
            <img className='h-[50vh] w-[250px]' src="src/assets/Gym-9.jpg" alt="" />
        </div>
        <div>
            <img className='h-[50vh] w-[250px]' src="src/assets/Gym-10.jpg" alt="" />
        </div>
        <div>
            <img className='h-[50vh] w-[250px]' src="src/assets/Gym-11.jpg" alt="" />
        </div>
        <div>
            <img className='h-[50vh] w-[250px]' src="src/assets/Gym-12.jpg" alt="" />
        </div>
        <div>
            <img className='h-[50vh] w-[250px]' src="src/assets/Gym-13.jpg" alt="" />
        </div>
        <div>
            <img className='h-[50vh] w-[250px]' src="src/assets/Gym-14.jpg" alt="" />
        </div>
        <div>
            <img className='h-[50vh] w-[250px]' src="src/assets/Gym-15.jpg" alt="" />
        </div>
        <div>
            <img className='h-[50vh] w-[250px]' src="src/assets/Gym-16.jpg" alt="" />
        </div>
      </div>
    </div>
