    ...
    return(
        ...
        <div className="banner">
            <div className="slider" style={{'--quantity': 12}}>
                ...
                <div className="item" style={{'--position': 4}}><img src="assets/client1.jpg" alt="" /></div>
                <div className="item" style={{'--position': 5}}><img src="assets/client2.jpg" alt="" /></div>
                <div className="item" style={{'--position': 6}}><img src="assets/client3.jpg" alt="" /></div>
                ...
                <div className="item" style={{'--position': 9}}><img src="assets/client3.jpg" alt="" /></div>
                <div className="item" style={{'--position': 10}}><img src="assets/client1.jpg" alt="" /></div>
                <div className="item" style={{'--position': 11}}><img src="assets/client2.jpg" alt="" /></div>
